...
- Código: fundação executável, persistência base, valores de e-mail/senha, relógio, tokens seguros e retorno interno validado concluídos.
- Próxima tarefa: `T-001-014` — implementar o `UserRepository`.
